...
namespace Tests\AcmeCore\Ssl\Parser;
...
use InfinityFree\AcmeCore\Ssl\PublicKey;
...
class KeyParserTest extends TestCase
{
    ...
    {
        $this->expectException('InfinityFree\AcmeCore\Ssl\Exception\KeyParsingException');
