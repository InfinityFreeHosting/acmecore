...
use InfinityFree\AcmeCore\Ssl\ParsedCertificate;
use InfinityFree\AcmeCore\Ssl\Parser\CertificateParser;
...
class CertificateParserTest extends TestCase
{
    ...
    {
        $this->expectException('InfinityFree\AcmeCore\Ssl\Exception\CertificateParsingException');
